// Jwt처리 유틸리티 클래스 JwtProcessor를 정의
...
public class JwtProcessor {
    ...
    private String secretKey = "충분히 긴 임의의(랜덤한) 비밀키 문자열배정";
...
// 예외ExpiredJwtException, UnsupportedJwtException, MalformedJwtException, SignatureException,
